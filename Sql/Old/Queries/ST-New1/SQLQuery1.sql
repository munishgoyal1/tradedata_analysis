...
set @margin_fraction = 0.2
    ...
    select * from
		 ...
		 ,((SUM(actual_profit) * 100) /((SUM(average_trade_price * quantity * @margin_fraction))/count(*))) as ROI
		  ...
		  ,SUM(brokerage * .3 + actual_profit) as OPTIM_P
		  ...
		  --,SUM(brokerage) as ACTUAL_BROK
		   ...
		   where 
		   --algo_id = @algo_id and
		   algo_id in ( 17, 18, 19, 30, 31, 32, 40, 41, 42) and
		   --algo_id > 42 and
		   --and r1 = @r1
