select market_direction_percentage, SUM(roi_percentage) as roi_perc_sum

from --stocktrader.dbo.
st_trading_eop_statsbook

 where market_direction_percentage > 0  and algo_id = 1 --and contract_name != 'SENSEX'
